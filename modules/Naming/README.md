...
source = "git::https://dev.azure.com/azure-forge/Modules/_git/Modules//modules/Naming?ref=v0.2.89"
```
...
| `monitor_scheduled_query_rules` | `sqr-`     | `"sqr-${join("-", module.naming["this"].suffix)}"`          | LogAnalyticsAlerts                  |
| `monitor_alert_processing_rule` | `apr-`     | `"apr-${join("-", module.naming["this"].suffix)}"`          | AlertProcessingRule                 |
