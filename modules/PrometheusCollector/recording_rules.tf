###############################################################
# Recommended Prometheus Recording Rules for AKS (Linux)
# Source: Microsoft Azure Samples — aks-managed-prometheus-and-grafana-bicep
...
resource "azurerm_monitor_alert_prometheus_rule_group" "k8s_recording" {
  count = var.enable_recording_rules ? 1 : 0
