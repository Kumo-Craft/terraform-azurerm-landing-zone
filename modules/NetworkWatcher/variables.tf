...
variable "name" {
  type        = string
  default     = null
  description = "Optional. Explicit name override. If null, computed from naming components via the Naming submodule."
...
variable "workload" {
  ...
  default     = null
  nullable    = true
  description = "Workload suffix (e.g. platform). Required when `name` is null."
...
variable "resource_group_name" {
  type        = string
  nullable    = false
  description = "Name of the resource group in which to create the Network Watcher. Must be caller-provided."
}
